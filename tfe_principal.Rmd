...
# Método 3 (flexbib):
flexbib: true
# https://www.latex.um.es/retazos/leccion_15/flexbib.html (documentación flexbib)
flexbiboptions: authoryear # no numera, por defecto
#flexbiboptions: yearend,nocomment, noabstract  # no numera bibliografía
#flexbiboptions: plain # numera bib
#flexbiboptions: plain,nocomment, noabstract # numera bib
#flexbiboptions: apa7 # no numera
#flexbiboptions: HE # no numera
link-citations: yes
output: 
  pdf_document:
    keep_tex: no
...
<!-- \nocite{*} -->
\nocite{Luque2017,RStudio,R-base2,
R-knitr,R-rmarkdown,
webfacmatematicasus1,webPedroLuque}
